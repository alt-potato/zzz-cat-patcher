...
logl.info(
	"Removing AAI precision cannon shells" .. (unsafe_to_remove and " (hiding only)") .. " in favor of VTK magazines..."
)

mlib.remove_item("cannon-shell-precision", opt)
mlib.remove_item("explosive-cannon-shell-precision", opt)
